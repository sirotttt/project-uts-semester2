                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class='table-success'><?= $row['cc'] ?></td>
                                    <td><?= $row['stok'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-circle btn-outline-danger m-2"><a href="delete_produk.php?iddel=<?= $row['id'] ?>"><i class="fa fa-trash" aria-hidden="true" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?= $row['nama_motor'] ?>?'))
